...
import static com.example.project.chatwindow.reciverIImg;
import static com.example.project.chatwindow.senderImg;
...
public class messagesAdpter extends RecyclerView.Adapter {
    ...
    public int getItemCount() {
        if (messagesAdpterArrayList != null) {
            ...
            return 0; // or any other appropriate value depending on your use case
        }
    }
